...
int main(int argc, char *argv[]) {
  ...
  TEST_RET_MESSAGE(baseline(), "COMPILATION", 1, 0.66667); 
  TEST_RET_MESSAGE(test(height, n), "CORRECTNESS-ONLY-TEST", 1, 1.0); 
  TIME_RATIO(test(height, n), test(height2, n2), "", 1, 2.5, 1.66667);
